...
public class ReDiscoverBanner implements java.io.Serializable {
     ...
     * full constructor
     */
    public ReDiscoverBanner(String bannerTitle, String bannerImg, Integer bannerStatus, String bannerUrl, Integer bannerOrder, String limitVersion, String maxVersion, String limitChannelName, String limitPackageName, Integer isShow, Integer minVersionCode, Integer maxVersionCode) {
